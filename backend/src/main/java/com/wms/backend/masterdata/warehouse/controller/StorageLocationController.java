...
public class StorageLocationController {
    ...
    @ApiResponse(responseCode = "201", description = "Create location successfully")
    ...
    @ApiResponse(responseCode = "200", description = "Get location success")
    ...
    @ApiResponse(responseCode = "200", description = "Update location success")
    ...
    @ApiResponse(responseCode = "204", description = "Delete location success")
    ...
    @ApiResponse(responseCode = "200", description = "Get all locations success")
